...
/**
 * 5043번 샵에 대한 리뷰의 satisfaction을 2로 변경하는 스크립트
 */

async function updateShop5043Reviews() {
  try {
    console.log('🔍 5043번 샵에 대한 리뷰 찾기...');

    // 1. 5043번 샵에 대한 모든 리뷰 찾기
    ...
    if (reviews.length === 0) {
      console.log('❌ 5043번 샵에 대한 리뷰가 없습니다.');
      return;
    }
