...
export const ListDetailScreen = ({ userIdProp }: ListDetailProps = {}) => {
    ...
    return (
        <div className="flex flex-col h-full bg-background relative">
            ...
            <div
                className={cn(
                    "fixed top-0 left-1/2 -translate-x-1/2 w-full max-w-md z-[100] flex items-center justify-between px-4 py-3 transition-all duration-300 border-b pointer-events-none",
