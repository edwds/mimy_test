        ...
        <div className="flex flex-col h-full bg-background pt-safe-offset-0 pb-safe-offset-6">
            ...
            <div className="px-6 pb-4">
                <p className="text-sm text-muted-foreground">
                    {t('onboarding.screenshot_upload.instruction', { defaultValue: '예약 앱의 예약/방문 내역 스크린샷을 올려주세요 (최대 5장)' })}
                </p>
            </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                    ...
                    {images.length < 5 && (
                        <button
                            ...
                            className="aspect-[3/4] rounded-xl border-2 border-dashed border-muted-foreground/30 flex flex-col items-center justify-center gap-2 hover:border-primary/50 transition-colors"
                        >
            ...
            <div className="px-6 pt-3 pb-4 space-y-3">
                {analyzing ? (
                    <div className="flex flex-col items-center gap-3 py-4">
                        ...
                        <p className="text-sm text-muted-foreground">
                            {t('onboarding.screenshot_upload.analyzing', { defaultValue: 'AI가 스크린샷을 분석하고 있어요...' })}
                        </p>
                    </div>
                ) : (
                    <Button
                    ...
                    >
                        {anyUploading
                            ...
                            : t('onboarding.screenshot_upload.analyze_button', { defaultValue: `${images.length}장 분석하기` })}
                    </Button>
                )}
            </div>
        </div>
